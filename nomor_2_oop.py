...
class ModelHandler:
    ...
    def handle_balance_variable(self):
        self.x_train['Balance'] = np.log(np.array(self.x_train['Balance']) + 1)
        

    def split_data(self):
        self.x_train, self.x_test, self.y_train, self.y_test = train_test_split(self.input_data, self.output_data, test_size=0.2, random_state=42)
    ...
    def handle_imbalanced(self):
        ...
        self.x_train = x_train_resampled.copy()
        self.y_train = y_train_resampled.copy()
